#from modules.adduser import createuser as cu
from modules import adduser as au
...
def maindash():
    ...
    if userinput == 1:
        ...
        au.createuser(input_userid, input_username, input_userphone, input_useraddress)
    elif userinput == 3:
